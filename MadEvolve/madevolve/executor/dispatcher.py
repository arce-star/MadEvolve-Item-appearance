...
class LocalRunner:
    ...
    def submit(
        ...
        # Build command — pass --results_dir + --verbose so eval shows progress
        cmd = ["python", evaluator_script, code_path, "--results_dir", work_dir_abs, "--verbose"]
        ...
        # stdout → file, stderr → terminal (so progress bar visible)
        ...
        process = subprocess.Popen(
            ...
            cwd=work_dir,
            stdout=stdout_file,
            stderr=None,  # goes to terminal, shows progress bar
            env=os.environ.copy(),
        )
